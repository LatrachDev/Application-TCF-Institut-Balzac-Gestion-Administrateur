...
function endQuiz() {
  ...
  // Validation si le score maximal est atteint
  if (score === 10) {
      categoryData.validation = true;
  }

  // Vérifier si le niveau est terminé et afficher un message
  if (checkLevelCompletion(userData, currentLevel)) {
      showLevelCompletionMessage();
  }
  ...
  updateTableData(); // S'assurer que cette fonction existe pour actualiser les affichages
}
